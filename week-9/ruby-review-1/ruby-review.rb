...
# no need, initial solution passed my check for DRYness
...
# This was a fun review of ruby class structure and the real challenge was in the pseudocoding.

# What is still confusing to you about Ruby?
# In this challenge the hardest part was pseudocoding to wrap my head around the problem and 
# luckily translating it to code went smoothly and it passed the driver code on the first try.

# What are you going to study to get more prepared for Phase 1?
# I'm feeling good about class structure and will be reviewing iteration.
