...
When iterating a looped-in number varible it needs to be reset every time around, we were
hung up on this for a long time because the highest secretary value is more than the
highest treasurer value so it didn't even register a winner.

Were you able to find useful methods to help you with this?
We stuck to for and if with comparative operators for this, they were enough to create
the loops and functions we needed to make this happen. 

What concepts were solidified in the process of working through this challenge?
This was a good lesson against tunnel vision, we tried a lot of things and could not get
the first part to work, took a break, and saw we had an extra for loop. The we got hung
up on the second part and realized we needed our num variable to reset each time through 
the loop. It's hard to not get hung up on the last part you worked on and look at the whole
problem instead. 
